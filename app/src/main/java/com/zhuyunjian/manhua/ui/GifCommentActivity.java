...
@EActivity(R.layout.activity_gif_comment)
public class GifCommentActivity extends BaseActivity implements CommentView,PullToRefreshBase.OnRefreshListener2{
    ...
    @ViewById(R.id.gif_ptr_listview)
    ...
    public void initView() {
        ...
        headView = inflater.inflate(R.layout.gif_head,null);
        sdView = (SimpleDraweeView) headView.findViewById(R.id.gif_gif_sdview);
        titleText = (TextView) headView.findViewById(R.id.gif_title);
        dingText = (TextView) headView.findViewById(R.id.gif_ding_text);
        caiText = (TextView) headView.findViewById(R.id.gif_cai_text);
        collectText = (TextView) headView.findViewById(R.id.gif_collect_text);
        changeTitle();
    ...
    @Override
    public void failed() {
        Toast.makeText(GifCommentActivity.this, "网络错误", Toast.LENGTH_SHORT).show();
    }
